...
<script src="{{ asset('js/modules/siat/service-branches.js') }}"></script>
<script src="{{ asset('js/modules/siat/service-pos.js') }}"></script>
...
<script src="{{ asset('js/modules/siat/components/puntos-venta.js') }}"></script>
