	...
	ns.ProductForm = {
		template: `<div class="form-invoices">
			<form ref="form" novalidate>
				...
				<div class="mb-3">
					<button type="button" class="btn btn-danger" data-dismiss="modal" data-coreui-dismiss="modal">Cancelar</button>
			...
			async save()
			{
				try
				{
					...
					const res = this.product.id > 0 ? 
						await this.$root.api.Put(`/invoices/products`, this.product) : 
						await this.$root.api.Post(`/invoices/products`, this.product);
