...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //## begin siat
            $form_fields = array_merge($form_fields, ['unidad_medida', 'actividad_economica', 'codigo_producto_sin']);
            //## end siat
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $module_form_fields = $this->moduleUtil->getModuleFormField('product_form_fields');
            //## begin siat
            $module_form_fields = array_merge($module_form_fields, ['unidad_medida', 'actividad_economica', 'codigo_producto_sin']);
            //## end siat
            if (!empty($module_form_fields)) {
